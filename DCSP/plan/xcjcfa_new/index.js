(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control28_spLZTe: function (elem) {
      if (!elem) {
        return '';
      }var obj = {};var doc = elem.ownerDocument;
      obj.wsbh_h = doc.querySelector('#wsbh_h').value;obj.wsbh_y = doc.querySelector('#wsbh_y').value;obj.wsbh_n = doc.querySelector('#wsbh_n').value;return obj;
    },
    doAction_uiControl35_PGJ0Wc: function (data, elem) {},
    getTemplate_uiControl35_PGJ0Wc: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    var data = this.props.data.customData;\n    return (\n      <div>\n       ( <span>{data.wsbh_h}</span> )\u5B89\u76D1\u68C0\u67E5 \u3014<span>{data.wsbh_y}</span>\u3015 <span>{data.wsbh_n}</span>\u53F7\n      </div>\n    )\n  }\n});';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    var data = this.props.data.customData;\n    return React.createElement(\n      "div",\n      null,\n      "( ",\n      React.createElement(\n        "span",\n        null,\n        data.wsbh_h\n      ),\n      " )\\u5B89\\u76D1\\u68C0\\u67E5 \\u3014",\n      React.createElement(\n        "span",\n        null,\n        data.wsbh_y\n      ),\n      "\\u3015 ",\n      React.createElement(\n        "span",\n        null,\n        data.wsbh_n\n      ),\n      "\\u53F7"\n    );\n  }\n});';
    },
    getData_control43_3ShuQP: function (elem) {
      if (!elem) {
        return '';
        ...
        if (trs[i].id == 'shspyj' || trs[i].id == 'shspqm' || trs[i].id == 'shspsj') {
          ...
          var tds = trs[i].querySelectorAll('td');if (tds.length == 2) {
            ...
            if (!tds[1].querySelector('input')) {
              ...
              ob.key = tds[0].textContent;ob.value = tds[1].querySelector('input').value + '-' + tds[2].querySelector('input').value;ob.click = 'on';ob.type = 'input';data.push(ob);continue;
              ...
              continue;
            }ob.key = tds[2].textContent;ob.value = tds[3].querySelector('input').value;ob.click = tds[3].querySelector('input').getAttribute('onclick') ? 'on' : 'off';ob.type = 'input';data.push(ob);
          }
        }
      }return data;
    },
    doAction_uiControl38_sbnlWR: function (data, elem) {
    ...
    getData_control64_TUWawM: function (elem) {
      if (!elem) {
        return '';
    ...
    doAction_uiControl84_2A6yzK: function (data, elem) {
    ...
    getTemplate_uiControl84_2A6yzK: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  click: function(e) {\n    var handler = this.props.customHandler;\n    handler({\n      eventType: \'click\',\n      data: e.target.getAttribute(\'data-id\')\n    })\n  },\n  render: function() {\n    var data = this.props.data.customData || [];\n    var me =this;\n    var list = data.map(function(d,i){\n      return(\n        <li className={i != data.length-1 ? "borderB paddingTB10":\'paddingTB10\'}>\n          <p>{d.title}</p>\n          <div>\n            <span>{d.s1}</span>\n            <span>{d.i1}</span>\n            <a data-id={i} onClick={me.click}>{d.sp1}</a>\n          </div>\n          {d.date==\'\u5E74\u6708\u65E5\'?\'\':<p>{d.date}</p>}\n        </li>\n      )\n    });\n    return (\n      <div className="paddingTB10">\n        <ul className="sp-ul poc-ul marginT20">\n          {list}\n        </ul>\n      </div>\n    )\n  }\n});';
      return '\'use strict\';\n\nmodule.exports = React.createClass({\n  displayName: \'exports\',\n\n  click: function click(e) {\n    var handler = this.props.customHandler;\n    handler({\n      eventType: \'click\',\n      data: e.target.getAttribute(\'data-id\')\n    });\n  },\n  render: function render() {\n    var data = this.props.data.customData || [];\n    var me = this;\n    var list = data.map(function (d, i) {\n      return React.createElement(\n        \'li\',\n        { className: i != data.length - 1 ? "borderB paddingTB10" : \'paddingTB10\' },\n        React.createElement(\n          \'p\',\n          null,\n          d.title\n        ),\n        React.createElement(\n          \'div\',\n          null,\n          React.createElement(\n            \'span\',\n            null,\n            d.s1\n          ),\n          React.createElement(\n            \'span\',\n            null,\n            d.i1\n          ),\n          React.createElement(\n            \'a\',\n            { \'data-id\': i, onClick: me.click },\n            d.sp1\n          )\n        ),\n        d.date == \'\u5E74\u6708\u65E5\' ? \'\' : React.createElement(\n          \'p\',\n          null,\n          d.date\n        )\n      );\n    });\n    return React.createElement(\n      \'div\',\n      { className: \'paddingTB10\' },\n      React.createElement(\n        \'ul\',\n        { className: \'sp-ul poc-ul marginT20\' },\n        list\n      )\n    );\n  }\n});';
    },

    getData_control68_Ow2Gvo: function (elem) {
      if (!elem) {
        return;
      }return elem.innerHTML;
    },
    doAction_uiControl86_WLhxxU: function (data, elem) {
    ...
    getTemplate_uiControl86_WLhxxU: function () {
