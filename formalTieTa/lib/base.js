...
//      alert(aWin.location.href); if(aWin.location.href.indexOf('http://fms.chinatowercom.cn:81/cwbase/gsp/webservice/RESTFulWebService/RESTFulHandlerForWeb.ashx')!=-1 || aWin.location.href.indexOf('http://fms.chinatowercom.cn:81/cwbase/web/gspwf/zh-Cn/ApprovalCenter.html')!=-1 || aWin.location.href.indexOf('http://fms.chinatowercom.cn:81/cwbase/web/gspwf/approvalcenter.html')!=-1 || aWin.location.href.indexOf('http://fms.chinatowercom.cn:81/cwbase/web/login')!=-1){
...
//           }
        aWin.addEventListener('DOMContentLoaded',function(){
            ...
            var time = year+'-'+month+'-'+day+' '+hh+':'+mm+':'+ss+'.'+ms;
            var num = year+month+day+hh+mm+ss+ms;
						...
						data+='<MsgId>60.6004_'+num+'</MsgId>'  //sender+yymmdd
						data+='<AuthCode/>'
						data+='<TransId/>'
						data+='<TransId/>'
						data+='<AuthType/>'
						data+='<Version/>'
						data+='<MsgId>20.2001_'+num+'</MsgId>'
						data+='</Route>'
						data+='</Esb>'
						data+='</soapenv:Header>'
						data += '<soapenv:Body>';
              ...
              debugger;
						...
						var urlToken = "http://fms.chinatowercom.cn:81/cwbase/jtgl/Verification/Verification.aspx?Login=ZGTT&token="+token+"&appAcctId="+APPACCTID+"&flag=1";
