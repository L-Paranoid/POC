...
ysp.appMain.resolveCompatibility('all', function(win) {
	try {
		win.Object.defineProperty(win.Document.prototype, 'all', {
			get: function() {
				var me = this;
				function getAll(id) {
					var elems = me.getElementsByName(id);
					if (elems && elems.length > 0) {
						return elems[0];
					}
					return me.getElementById(id);
				}

				var elems = [].slice.call(me.querySelector('[name],[id]'));
...
ysp.appMain.resolveCompatibility('Node', function(win) {
	try {
...
/*按需添加
	win.Object.defineProperty(win.Node.prototype, 'baseName', {
		get: function() {
