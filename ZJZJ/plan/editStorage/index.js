  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl19_pROfAO: function (data, elem) {
      if (data.eventType == 'click') {
        //ysp.appMain.back();
        elem.ownerDocument.defaultView.history.back();
      }
    },
    ...
    getData_control18_KNDdQq: function (elem) {
      if (!elem) {
        return false;
      }var edit = [];var trs = elem.querySelector('table >tbody').children;[].forEach.call(trs, function (item, index) {
        if (item) {
            ...
            if (d) {
              if (i % 2 == 0) {
                ...
                if (d.lastChild.nodeName == "SPAN") {
                  ...
                  All.content.push(ysp.customHelper.trim(d.querySelectorAll('input')[1].value));
                }
              }
            }
          });edit.push(All);
    ...
    doAction_uiControl18_N6k5Wf: function (data, elem) {
      if (data.eventType == 'change') {
        var index = parseInt(data.dataCustom.index);var Pindex = parseInt(data.dataCustom.Pindex);debugger;if (Pindex == 0) {
          switch (index) {case 0:
              changeValue('input[name="checkTaskNo"]');break;case 1:
              changeValue('input[name="prodName"]');break;case 2:
              changeValue('input[name="prodDetailName"]');break;}
        } else if (Pindex == 1) {
          switch (index) {case 0:
              changeValue('input[name="checkPlanNo"]');break;case 1:
              changeValue('input[name="checkPlanName"]');break;case 2:
              changeValue('input[name="produceOrganName"]');break;}
        } else if (Pindex == 2) {
          switch (index) {case 0:
              changeValue('input[name="receiveDate"]');break;case 1:
              changeValue('input[name="receivedPerson"]');break;case 2:
              changeValue('input[name="receivedPersonPhone"]');break;}
        } else if (Pindex == 3) {
          switch (index) {case 0:
              changeValue('input[name="courierNumber"]');break;case 1:
              changeValue('input[name="inspOrgPerson"]');break;case 2:
              changeValue('input[name="inspOrgPersonPhone"]');break;}
          ...
          }elem.querySelector(id).previousElementSibling.click();elem.querySelector(id).previousElementSibling.focus();elem.querySelector(id).previousElementSibling.value = value; //elem.querySelector(id).previousElementSibling.blur();
          elem.querySelector(id).value = value;
        }
      }
    },
    getTemplate_uiControl18_N6k5Wf: function () {
      var selfTemplate = 'import {Component} from \'react\';\nexport default class extends Component{\n  onChange(e){\n    if(e.target.nodeName == "INPUT"){\n      var _this = this;\n      var handler = _this.props.customHandler;\n      if(handler){\n        handler({\n          data:{index:e.target.parentNode.parentNode.dataset.index,\n                value:e.target.value,\n                Pindex:e.target.parentNode.parentNode.dataset.pindex},\n          eventType:\'change\'\n        })\n      }\n    }\n  }\n  render(){\n    var _this = this;\n    var data = this.props.customData.edit;\n    return (\n    \t<div className=\'edit-storage\'>\n        {data && data.map((item,index)=>{\n          return (\n            <ul>\n              {item.title.map((d,i)=>{\n                if(d){\n                  d = d.replace(\'\uFF1A\',\'\')\n                }\n                return (\n                \t<li data-index={i} data-Pindex={index} onBlur={_this.onChange.bind(_this)}>\n                    <div>{d.indexOf(\'*\') !=-1?<span className=\'title\'><b>*</b>{d.replace(\'*\',\'\')}</span>:<span className=\'title\'>{d}</span>}\n                    { d.indexOf(\'\u65E5\u671F\') != -1?<AInput className=\'content\' type=\'date\' value={item.content[i]}/>: d.length>1 && <AInput className=\'content\' type=\'text\' value={item.content[i]} onFocus={(e)=>{\n                            if(e.target.value.indexOf(\'\u8BF7\u8F93\')!=-1){\n                              e.target.value = \'\';\n                            }\n                          }}/> }</div>\n              \t\t</li>\n                )\n              })}\n            </ul>\n          )\n        })}\n      </div>\n    )\n  }\n}';
      return '\'use strict\';\n\nObject.defineProperty(exports, "__esModule", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = require(\'react\');\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn\'t been initialised - super() hasn\'t been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar _class = function (_Component) {\n  _inherits(_class, _Component);\n\n  function _class() {\n    _classCallCheck(this, _class);\n\n    return _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).apply(this, arguments));\n  }\n\n  _createClass(_class, [{\n    key: \'onChange\',\n    value: function onChange(e) {\n      if (e.target.nodeName == "INPUT") {\n        var _this = this;\n        var handler = _this.props.customHandler;\n        if (handler) {\n          handler({\n            data: { index: e.target.parentNode.parentNode.dataset.index,\n              value: e.target.value,\n              Pindex: e.target.parentNode.parentNode.dataset.pindex },\n            eventType: \'change\'\n          });\n        }\n      }\n    }\n  }, {\n    key: \'render\',\n    value: function render() {\n      var _this = this;\n      var data = this.props.customData.edit;\n      return React.createElement(\n        \'div\',\n        { className: \'edit-storage\' },\n        data && data.map(function (item, index) {\n          return React.createElement(\n            \'ul\',\n            null,\n            item.title.map(function (d, i) {\n              if (d) {\n                d = d.replace(\'\uFF1A\', \'\');\n              }\n              return React.createElement(\n                \'li\',\n                { \'data-index\': i, \'data-Pindex\': index, onBlur: _this.onChange.bind(_this) },\n                React.createElement(\n                  \'div\',\n                  null,\n                  d.indexOf(\'*\') != -1 ? React.createElement(\n                    \'span\',\n                    { className: \'title\' },\n                    React.createElement(\n                      \'b\',\n                      null,\n                      \'*\'\n                    ),\n                    d.replace(\'*\', \'\')\n                  ) : React.createElement(\n                    \'span\',\n                    { className: \'title\' },\n                    d\n                  ),\n                  d.indexOf(\'\u65E5\u671F\') != -1 ? React.createElement(AInput, { className: \'content\', type: \'date\', value: item.content[i] }) : d.length > 1 && React.createElement(AInput, { className: \'content\', type: \'text\', value: item.content[i], onFocus: function onFocus(e) {\n                      if (e.target.value.indexOf(\'\u8BF7\u8F93\') != -1) {\n                        e.target.value = \'\';\n                      }\n                    } })\n                )\n              );\n            })\n          );\n        })\n      );\n    }\n  }]);\n\n  return _class;\n}(_react.Component);\n\nexports.default = _class;';
    },
